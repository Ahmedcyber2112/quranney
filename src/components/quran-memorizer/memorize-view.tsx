...
import { Play, Pause, SkipBack, SkipForward, Repeat, Repeat1, BookOpen, ChevronUp, ChevronDown, Trash2, Eye, EyeOff, Gauge, Loader2 } from "lucide-react";
  ...
  useEffect(() => {
    const playTrack = async (index: number) => {
      ...
      try {
        ...
        // استخدام API مباشرة بدون Cache معقد
          ...
          if(isPlaying) {
             try {
               ...
               if (error instanceof Error && error.name === 'AbortError') {
                 console.log('Audio play was interrupted by new request');
        ...
        toast({ variant: "destructive", title: "خطأ", description: "لا يمكن تحميل الملف الصوتي" });
        playNext();
      } finally {
        ...
        <CardContent className="flex-grow overflow-y-auto">
          <div className="space-y-6 text-right">
            ...
            <div>
              ...
              <RadioGroup value={playbackMode} onValueChange={(value: string) => handleSettingsChange('playbackMode', value as PlaybackMode)} className="mt-2 space-y-2">
          ...
          <ScrollArea className="h-[calc(100vh-220px)] lg:h-[calc(100vh-160px)]">
            {showAyahs ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center p-6">
                    ...
                    <p className="text-muted-foreground">اضغط على زر &ldquo;إظهار الآيات&rdquo; في الإعدادات لعرضها.</p>
                </div>
              )}
          </ScrollArea>
        </Card>
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuRadioGroup value={String(playbackRate)} onValueChange={(val: string) => handleSettingsChange('playbackRate', Number(val))}>
