...
import { ArrowLeft, Flame, Gift, Headphones, Milestone, Repeat, ShieldCheck, Speaker, Star, Users, BrainCircuit, HeartHandshake } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background">
                ...
                <div className="flex flex-col justify-center space-y-4 text-center lg:text-right">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed">
                           صاحب القرآن هو موقع يهدف إلى نشر حفظ كتاب الله بأسلوب سهل وفعّال، مستمد من السنة المطهّرة، يساعد المسلم على بناء علاقة يومية مع القرآن، ويجعله &ldquo;صاحبًا&rdquo; حقيقيًا له في الدنيا والآخرة.
                        </p>
                    </div>
                </div>
      ...
      <footer className="flex flex-col items-center justify-center py-6 border-t bg-card space-y-4">
        ...
        <Button variant="outline" size="lg" asChild className="group">
          <Link 
            href="https://www.linkedin.com/in/ahmed-soliman-2112ip/" 
            target="_blank" 
